...
import { ArrowLeft, Wifi, WifiOff, AlertTriangle, HardDrive } from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        >
          ...
          <div className="flex justify-between" style={{ fontSize: '14px' }}>
            ...
            <span className="text-gray-900">{totalSize} MB</span>
          </div>
          <div className="space-y-2">
            <div className="flex justify-between" style={{ fontSize: '14px' }}>
              <span className="text-gray-600">Gesamtfortschritt:</span>
              <span className="text-blue-500">{Math.round(totalProgress)}%</span>
            </div>
          ...
          {files.map((file, index) => (
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-gray-900" style={{ fontSize: '14px' }}>{file.name}</p>
                  <p className="text-gray-500" style={{ fontSize: '12px' }}>{file.size.toFixed(1)} MB</p>
                </div>
